...
import SponsorshipHubPage from './sponsorship-hub/SponsorshipHubPage';
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 glass-panel border-b-0 rounded-b-2xl mx-4 mt-2 px-6 h-16 flex items-center justify-between">
      ...
      <div className="hidden md:flex items-center gap-8">
        ...
        <Link to="/sponsorship-hub" className={`text-sm font-medium transition-colors ${isActive('/sponsorship-hub')}`}>Sponsor Hub</Link>
      ...
      <div className="flex items-center gap-4">
        ...
        {user ? (
          <div className="flex items-center gap-3">
            ...
            <button onClick={logout} className="text-xs text-gray-400 hover:text-white transition-colors hidden md:block">Logout</button>
          </div>
        ) : (
          <Link to="/auth">
    ...
    return (
        <div className="min-h-screen pt-24 px-4 pb-32 max-w-3xl mx-auto">
            ...
            <div className="flex items-center gap-2 mb-12 overflow-x-auto pb-2">
                {[1, 2, 3, 4, 5, 6].map(s => (
                    <div key={s} className={`flex-1 min-w-[30px] h-2 rounded-full transition-all ${s <= step ? 'bg-gradient-to-r from-blue-500 to-purple-500' : 'bg-white/10'}`}></div>
                ))}
            </div>
            ...
            <div className="glass-card p-6 md:p-8 rounded-3xl">
                ...
                {step === 4 && (
                    <div className="space-y-6">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-400 mb-2">Event Details</label>
                            <div className="relative">
                                <textarea 
                ...
                {step === 5 && (
                    <div className="space-y-6">
                         <h3 className="text-xl font-bold text-white">Sponsorship Settings</h3>
                                     ...
                                     return (
                                         <div 
                                            ...
                                            className={`p-3 rounded-xl border transition-all cursor-pointer flex items-center gap-3 ${
                                                isAllowed ? 'bg-purple-500/10 border-purple-500/50' : 'bg-white/5 border-white/10 opacity-60'
                                            }`}
                                         >
                                             <div className={`w-4 h-4 rounded flex items-center justify-center border ${isAllowed ? 'bg-purple-500 border-purple-500' : 'border-white/20'}`}>
                                                 {isAllowed && <Check className="w-2 h-2 text-white" />}
                                             </div>
                ...
                {step === 6 && (
                    <div className="text-center py-8">
                        ...
                        <p className="text-gray-400 mb-8">Confirm the updates for "{formData.title}".</p>
                ...
                {step === 3 && (
                    <div className="space-y-6">
                        ...
                        <div>
                             ...
                             {formData.imageUrl && (
                                 <img src={formData.imageUrl || 'https://picsum.photos/seed/preview/800/400'} alt="Preview" className="mt-4 w-full h-40 object-cover rounded-xl border border-white/10" />
                             )}
                        </div>
                    </div>
                )}
                ...
                {step === 5 && (
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                         <div className="text-center mb-6">
                            ...
                            <h3 className="text-2xl font-bold text-white">Sponsorship Menu</h3>
                            <p className="text-gray-400 text-sm">Select which items sponsors can purchase for your event.</p>
                         </div>
                             ...
                             <div className="space-y-4">
                                 ...
                                 <div className="flex items-center justify-between p-4 bg-white/5 rounded-xl border border-white/10">
                                    <div>
                                        ...
                                        <p className="text-[10px] text-gray-400">Sponsors can pay more for exclusive rights.</p>
                                    </div>
                                    <button 
                                        onClick={() => setFormData({
                                            ...formData,
                                        ...
                                        className={`w-12 h-6 rounded-full transition-colors relative ${formData.sponsorshipSettings?.allow_exclusivity ? 'bg-purple-600' : 'bg-gray-700'}`}
                                    >
...
const EventDetailsPage = () => {
    ...
    return (
        <div className="min-h-screen pt-0 pb-32">
             ...
             {showConfirm && (
                 <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                     <div className="absolute inset-0 bg-black/80 backdrop-blur-sm" onClick={() => !isProcessing && setShowConfirm(false)}></div>
                     <div className="glass-card p-8 rounded-3xl max-w-md w-full relative z-10 border border-white/20 shadow-2xl animate-in fade-in zoom-in duration-300">
                         <h3 className="text-2xl font-bold text-white mb-4">{event.price === 0 ? 'Confirm Registration' : 'Confirm Purchase'}</h3>
             ...
             <div className="relative h-[40vh] md:h-[50vh] w-full">
                 ...
                 <div className="absolute top-6 left-4 z-20 flex gap-3 items-center">
                     ...
                     {event.visibility === 'private' && (
                         <span className="px-3 py-1 bg-black/50 backdrop-blur border border-white/10 rounded-full text-xs font-bold text-gray-300 flex items-center gap-1">
                 ...
                 <div className="glass-card p-6 md:p-8 rounded-3xl mb-8 flex flex-col md:flex-row gap-8 items-start justify-between">
                     <div className="flex-1">
                         ...
                         <div className="flex flex-col gap-2 text-gray-300 text-sm md:text-base">
                             ...
                             <div className="flex items-center gap-2"><UserIcon className="w-5 h-5 text-purple-400" /> Hosted by {event.hostId === MOCK_USER.id || event.hostId === user?.id ? 'You' : (event.hostName || (event.hostId === 'h1' ? 'UFC Official' : 'Tech Giants'))}</div>
                         </div>
                     </div>
                         ...
                         {isHosting && (
                             <div className="glass-panel p-6 rounded-2xl">
                                 <div className="flex justify-between items-center mb-4">
                                     <h3 className="text-white font-bold">Attendees</h3>
                                     <span className="bg-purple-500/20 text-purple-400 px-2 py-0.5 rounded-full text-xs font-bold">{attendees.length}</span>
                                 </div>
                                 <div className="space-y-3 max-h-60 overflow-y-auto pr-2 no-scrollbar">
                                     {attendees.length === 0 ? (
                                         ...
                                         attendees.map(a => (
                                             <div key={a.id} className="flex items-center gap-3 p-2 rounded-xl hover:bg-white/5 transition-colors">
                                                 <img src={a.avatarUrl || 'https://picsum.photos/seed/user/200'} className="w-8 h-8 rounded-full border border-purple-500/30 object-cover" />
                                                 <div>
                                                     <p className="text-sm text-white font-medium leading-none mb-1">{a.name}</p>
          ...
          {!isLogin && (
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all"
        ...
        <div className="flex justify-between items-center mb-8">
          {[1, 2, 3].map(i => (
            <div key={i} className="flex items-center">
              <div className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-xs transition-colors ${step >= i ? 'bg-purple-600 text-white' : 'bg-white/5 text-gray-500'}`}>
                {i}
              </div>
              {i < 3 && <div className={`w-12 h-0.5 mx-2 ${step > i ? 'bg-purple-600' : 'bg-white/5'}`} />}
            </div>
          ))}
        </div>
        ...
        {step === 1 && (
          <div className="space-y-6 animate-in fade-in duration-300">
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm mt-1">How should others see you on Circle?</p>
            </div>
            <div className="space-y-1">
        ...
        {step === 2 && (
          <div className="space-y-6 animate-in fade-in duration-300">
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm mt-1">Add a bio and your location.</p>
            </div>
            <div className="space-y-4">
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 h-32 resize-none"
        ...
        {step === 3 && (
          <div className="space-y-6 animate-in fade-in duration-300">
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm mt-1">Select your interests to get better recommendations.</p>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-8 mb-12 text-center md:text-left animate-in fade-in slide-in-from-top-4 duration-500">
                <div className="relative group cursor-pointer" onClick={handleAvatarClick}>
                    <img 
                        ...
                        className="w-32 h-32 rounded-3xl object-cover border-2 border-purple-500/30 p-1 group-hover:border-purple-500 transition-all" 
                    />
                ...
                <div className="flex-1 space-y-4">
                    <div>
                        <div className="flex flex-col md:flex-row items-center md:items-end gap-3 mb-1">
                            ...
                            {user.username && <span className="text-purple-400 font-medium text-sm mb-1">@{user.username}</span>}
                        </div>
                    ...
                    {user.bio && <p className="text-gray-300 text-sm leading-relaxed max-w-xl">{user.bio}</p>}
                    ...
                    <div className="flex flex-wrap justify-center md:justify-start gap-2">
                        {Array.isArray(user.interests) && user.interests.map(interest => (
                            <span key={interest} className="px-3 py-1 bg-white/5 border border-white/10 rounded-full text-[10px] text-gray-400">
                                {interest}
                            </span>
                        ))}
                    </div>
            ...
            <div className="flex gap-8 border-b border-white/10 mb-8 overflow-x-auto no-scrollbar">
                {[
                    ...
                    <button 
                        ...
                        className={`pb-4 px-2 text-sm font-bold transition-all relative whitespace-nowrap flex items-center gap-2 ${activeTab === tab.id ? 'text-white' : 'text-gray-500 hover:text-gray-300'}`}
                    >
                        {tab.label}
                        {tab.count > 0 && <span className="text-[10px] bg-white/10 px-1.5 py-0.5 rounded-md">{tab.count}</span>}
                        {activeTab === tab.id && <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-purple-500 shadow-[0_0_10px_rgba(168,85,247,0.5)]" />}
                    </button>
                ))}
            </div>
                ...
                <div className="space-y-6 animate-in fade-in duration-500">
                    {hostedEvents.length > 0 ? (
                        ...
                        <div className="text-center py-20 bg-white/5 rounded-3xl border border-dashed border-white/10">
                            ...
                            <h3 className="text-xl font-bold text-white mb-2">No hosted events</h3>
                        ...
                        {receivedProposals.length > 0 ? (
                            <div className="grid grid-cols-1 gap-6">
                                {receivedProposals.map(proposal => (
                                    <div key={proposal.id} className="glass-card p-6 rounded-3xl border border-white/10 hover:border-purple-500/30 transition-all">
                                        <div className="flex justify-between items-start mb-4">
                                            <div>
                                                <h4 className="text-lg font-bold text-white">{proposal.eventTitle}</h4>
                                                <p className="text-sm text-purple-400 font-medium">From: {proposal.senderName}</p>
                                            </div>
                                            <div className="text-right">
                                                <p className="text-2xl font-bold text-white">${proposal.estimatedInvestment}</p>
      ...
      <HashRouter>
        <div className="bg-background min-h-screen text-white font-sans selection:bg-purple-500/30 selection:text-white">
          ...
          <Routes>
            ...
            <Route path="/sponsorship-hub" element={<SponsorshipHubPage />} />
