      ...
      <div className="max-w-5xl mx-auto space-y-12">
        ...
        <div className="space-y-4 max-w-2xl">
          ...
          <p className="text-gray-400 text-base leading-relaxed">
            Set your audience profile and attendance. Circle automatically prices every
            sponsorship slot. Sponsors see real value — you earn real revenue.
          </p>
        </div>
